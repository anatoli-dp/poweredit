...
export class CodeEditor {
    ...
    buildCodePanel() {
        ...
        editor.on('update', () => this.updateEditorContents());
    ...
    updateHtml(e) {
        ...
        let htmlCode = e.trim()//this.htmlCodeEditor.getContent().trim();
    ...
    updateEditorContents() {
        ...
        if (this.component) {
            ...
            this.editor.runCommand('codeEditor:html:set', {
                code: this.getComponentHtml(this.component)
            })

            this.editor.runCommand('codeEditor:css:set', {
                code: this.editor.CodeManager.getCode(this.component, 'css', {
                    cssc: this.editor.CssComposer
                })
            })
        }
